...
#define blueled 11 //blueled pin
#define greenled 10 //greenled pin
#define redled 9 //redled pin
...
digitalWrite(blueled, buz);// led on and off command
delay(100);
digitalWrite(greenled, buz); // led on and off command
delay(100);
digitalWrite(redled, buz); // led on and off command
